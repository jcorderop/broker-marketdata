...
class BitmexAdapterSuccessTest extends AbstractVerticleSpringBootTest {

  private static final int EXPECTED_MESSAGES = 5;
  private static final Logger logger = LoggerFactory.getLogger(BitmexAdapterSuccessTest.class);
  ...
  void create_successfully_a_websocket_client_publishing_raw_quotes(Vertx vertx, VertxTestContext testContext) throws Throwable {
    ...
    //when
    Future<String> stringFuture = vertx.deployVerticle(bitmexAdapter)
