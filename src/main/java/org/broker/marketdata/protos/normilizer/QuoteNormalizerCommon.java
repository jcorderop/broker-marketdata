...
public class QuoteNormalizerCommon {
  ...
  public static void internalQuoteValidation(Quote.Builder quote) {
    if (!quote.hasSymbol()) throw new IllegalStateException("Symbol not present.");
  }

  public static Optional<String> getStringValue(final DocumentContext ctx, final String fieldName) {
    try {
  ...
  public static Optional<Double> getDoubleValue(final DocumentContext ctx, final String fieldName) {
    try {
